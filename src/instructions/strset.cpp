...
Instructions::Strset::Strset(ControlFlow& controlFlow, Memory& memory): Instruction(controlFlow, memory)
{
    keys = {":", "<-"};
    keyPositions = {1, 3};
}

void Instructions::Strset::execute(Line line)
{
    ...
    memory.setStringElement(args[0], y, z);
}
